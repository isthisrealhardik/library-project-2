const Add = ({ addABook }) => {
    ...
    return(
        <div id="Add" className="fixed z-50 bg-gray-100 hidden flex-col justify-center items-center h-screen w-screen top-0 space-y-10">
            ...
            <img onClick={closeButton} src="./assets/close.svg" alt="Close" className="absolute top-[-20px] left-[310px]" />
            ...
            <div className="flex justify-center items-center flex-col space-y-4 w-screen">
                <select id="StatusInput" name="Status" className="button-style py-4 text-center w-[80%]">
                    <option value="Read">Read</option>
                    <option value="To Read">To Read</option>
                    <option value="Reading">Reading</option>
                </select>
                <button onClick={addABook} type="submit" className="button-style py-4 w-[80%]">Add</button>
            </div>
      </div>
    )
}
